...
Grab a ready to run build from the [Releases page](https://github.com/panason-m/genesha/releases)
— download the zip, extract it anywhere, and run `Genesha.exe`. No installer, no .NET SDK
